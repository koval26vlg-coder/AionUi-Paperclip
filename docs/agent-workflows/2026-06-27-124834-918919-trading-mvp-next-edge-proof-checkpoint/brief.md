...
Risk flags: trading research, long-running collector must be visible and must not be started without explicit user confirmation. No external media/channel/P2P/off-ramp/custody/legal analysis.
